...
import 'package:firebase_chat_clone/common/values/values.dart';
...
class FirebaseMassagingHandler {
  ...
  static AndroidNotificationChannel channel_call =
    ...
    'com.example.firebase_chat_clone.call', // id
    'chatclone_call', // title
  ...
  static AndroidNotificationChannel channel_message =
      const AndroidNotificationChannel(
    'com.example.firebase_chat_clone.message', // id
    'chatclone_message', // title
